...
:exclamation:  An official (not outdated) documentation can be found via [clone here](git://git.netfilter.org/iptables.git), see ip6tables.8.in & iptables.8.in. Also look [here](https://github.com/sigma-1/raw-android-patches/) for Android kernel patches. :exclamation: 

Changelog
-----------

Latest iptables official release: **iptables-1.4.7** -> [04-Dec-2015](https://git.netfilter.org/iptables/tree/release.sh)
